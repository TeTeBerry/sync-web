...
export function RelatedEventsError({ locale, labels }: RelatedEventsErrorProps) {
  return (
    <EmptyState
      className="related-events-empty related-events-empty--error"
      icon={WifiOff}
      title={labels.title}
      lead={labels.lead}
      variant="compact"
