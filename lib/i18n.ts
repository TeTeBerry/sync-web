...
export const messages = {
  zh: {
    ...
    home: {
      eyebrow: 'SYNC',
      titlePrefix: '发现电音节，',
      titleHighlight: '找蹦迪搭子',
      titleSuffix: '一起出发',
      lead: '查活动、看阵容、发现公开组队需求。在小程序平台上线前，网页端是 SYNC 的先行体验入口。',
      eventsCta: '发现活动',
      waitlistCta: '订阅组队更新',
      mediaPills: ['精选音乐节', '阵容更新', '公开招募'],
      featuredLabel: 'Featured Festival',
      featuredMetaFallback: '活动信息更新中',
    ...
    eventDetail: {
      ...
      signalTitle: '下一步想验证',
      signalCopy: '平台正式版上线前，欢迎订阅音乐节场次、查看各路蹦迪搭子招募，留下你的联络方式抢先体验。',
      join: '加入内测',
      moreEyebrow: 'More',
      moreTitle: '',
    },
  ...
  en: {
    ...
    home: {
      eyebrow: 'SYNC',
      titlePrefix: 'Discover festivals.',
      titleHighlight: 'Find Your Rave Squad',
      titleSuffix: 'before you go.',
      lead: 'Browse upcoming festivals, check DJ lineups, and find open squads while the full SYNC platform is getting ready.',
      eventsCta: 'Discover Events',
      waitlistCta: 'Get Squad Updates',
      mediaPills: ['Featured festival', 'Lineup updates', 'Open squads'],
      featuredLabel: 'Featured Festival',
      featuredMetaFallback: 'Event details updating',
    ...
    eventDetail: {
      ...
      signalCopy: 'While we prepare our full official platform, explore festival lineups, find open rave squads, and submit your contact details right here on the web.',
      join: 'Join Waitlist',
      moreEyebrow: 'More',
      moreTitle: '',
    },
